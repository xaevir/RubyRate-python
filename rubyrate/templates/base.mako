...
<script type="text/javascript" src="${request.static_url('rubyrate:static/jquery.masonry.min.js')}"></script>

${self.js()}

<script type="text/javascript" src="${request.static_url('rubyrate:static/raphael-min.js')}"></script>
